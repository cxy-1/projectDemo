<template>
    <div class="cjgl Evaluation trainMin">
                ...
                <el-col :span="24">
                    <el-row>
                        <el-col>
                            ...
                            <el-card class="card2 TrainingMinute">
                                ...
                                <div class="sqxx-info4">
                                    <div class="handle-box4 trainMinute">
                                        <el-form :inline="true" label-position="left" label-width="" ref='Evaluation' :model="Evaluation" class="demo-form-inline">
                                            <el-row :gutter="6" style="margin-bottom:0;padding-left:12px">
                                                <el-col :span="8">
                                    ...
                                    <div class="sqxx-table4" v-show="tableData.length>0?true:false">
...
export default {
    ...
    methods: {
        ...
        init(){
            var self = this;
            const _obj={
                url:self.global.serverPath8 + '/personnel/training/getAllTrainingInfo?personId='+self.$route.query.personID,
                isGet:true,
            };
