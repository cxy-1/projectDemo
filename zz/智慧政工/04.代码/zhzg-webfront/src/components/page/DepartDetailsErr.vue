  ...
  methods: {
    inquiry() {
      ...
      const _obj = {
        url:
          ...
          "/statistics/entryandexit/selectFormAndWithPeo",
        postData: {
    ...
    checkResult() {
      ...
      const _obj = {
        url:
          self.global.serverPath8 +
          "/statistics/entryandexit/selectCheckResult",
        postData: {
          idNumber: self.$route.query.idNumber
        }
      };
    ...
    init() {
      var self = this;
      self.$http
        .get(self.global.serverPath5 + "/selectLoeCheck", {
          //传递参数
          // params: {
...
<style>
.outCard .el-form-item--mini.el-form-item,
...
.recordTab .el-table__body td,
.papersTab .el-table__body td,
.errCheckCon .el-table__body td {
  font-size: 14px !important;
}
.papersCheck {
  padding: 0 20px;
